...
#total_budget =  200
random_state=5
input_file_path = os.path.join('../../data/pka/graph_split', 'node.txt')
train_n_datas, train_n_models, data_map, model_map, datas, models, data_embed, model_embed = read_nodes(input_file_path)
input_edge_path = os.path.join('../../data/pka/graph_split', 'edge.txt')
...
test_edge_path = os.path.join('../../data/pka/graph_split', 'new_edge.txt')
#process the new_edge.txt to a csv file:
#edges = change_to_csv_test_edges(test_edge_path,user_selected_metric)
test_node_path = os.path.join('../../data/pka/graph_split', 'new_node.txt')
...
train_ground_truth_file_path = os.path.join('../../data/pka/output','train_ground_truth.csv')
...
valid_ground_truth_file_path = os.path.join('../../data/pka/output','valid_ground_truth.csv')
np.savetxt(valid_ground_truth_file_path,valid_ground_truth, fmt='%i,%i,%f',delimiter=',')

##save the second_level_data_map
output_second_data_map_file_path = os.path.join('../../data/pka/output','second_data_map.txt')
...
output_train_file_path = os.path.join('../../data/pka/output', 'inductive_train.txt')
...
for items in train_edge_list:
    ...
    f.write('\n')
f.close()
output_val_file_path = os.path.join('../../data/pka/output', 'inductive_val.txt')
...
output_test_file_path = os.path.join('../../data/pka/output', 'inductive_test.txt')
...
##save train_edge_list , val_edge_list, test_edge_list
output_train_file_path = os.path.join('../../data/pka/output', 'initial_train.txt')
f=open(output_train_file_path, 'w')
for items in sampled_train_edge_list:
    ...
    f.write('\n')
f.close()
output_val_file_path = os.path.join('../../data/pka/output', 'initial_val.txt')
f=open(output_val_file_path, 'w')
...
output_test_file_path = os.path.join('../../data/pka/output', 'initial_test.txt')
f=open(output_test_file_path, 'w')
...
test_ground_truth_file_path = os.path.join('../../data/pka/output','test_ground_truth.csv')
...
output_ground_truth_file_path = os.path.join('../../data/pka/output','cutoff_ground_truth.csv')
...
output_data_embed_file_path = os.path.join('../../data/pka/output','data_embed.npy')
np.save(output_data_embed_file_path,data_embed)

##save data_map
output_data_map_file_path = os.path.join('../../data/pka/output','data_map.txt')
...
##save model_map
output_model_map_file_path = os.path.join('../../data/pka/output','model_map.txt')
...
output_model_embed_file_path = os.path.join('../../data/pka/output','model_embed.npy')
