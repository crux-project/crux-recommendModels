...
train_ground_truth_file_path = os.path.join('../../data', dataset_path_name,'output', 'train_ground_truth.csv')
...
valid_ground_truth_file_path = os.path.join('../../data', dataset_path_name, 'output','valid_ground_truth.csv')
...
output_second_data_map_file_path = os.path.join('../../data', dataset_path_name, 'output','second_data_map.txt')
...
output_train_file_path = os.path.join('../../data', dataset_path_name, 'output', 'inductive_train.txt')
...
output_val_file_path = os.path.join('../../data',dataset_path_name, 'output', 'inductive_val.txt')
...
output_test_file_path = os.path.join('../../data',dataset_path_name, 'output', 'inductive_test.txt')
...
output_train_data_maps_file_path = os.path.join('../../data', dataset_path_name, 'output','inductive_train_dict.txt')
...
output_val_data_maps_file_path = os.path.join('../../data', dataset_path_name, 'output','inductive_val_dict.txt')
...
output_test_data_maps_file_path = os.path.join('../../data', dataset_path_name, 'output','inductive_test_dict.txt')
...
output_sampled_train_data_maps_file_path = os.path.join('../../data',dataset_path_name, 'output','initial_train_dict.txt')
...
output_sampled_val_data_maps_file_path = os.path.join('../../data', dataset_path_name, 'output','initial_val_dict.txt')
...
output_sampled_test_data_maps_file_path = os.path.join('../../data', dataset_path_name, 'output','initial_test_dict.txt')
...
output_train_file_path = os.path.join('../../data', dataset_path_name, 'output', 'initial_train.txt')
f=open(output_train_file_path, 'w')
...
output_val_file_path = os.path.join('../../data', dataset_path_name, 'output', 'initial_val.txt')
f=open(output_val_file_path, 'w')
...
output_test_file_path = os.path.join('../../data', dataset_path_name, 'output', 'initial_test.txt')
f=open(output_test_file_path, 'w')
...
test_ground_truth_file_path = os.path.join('../../data', dataset_path_name, 'output','test_ground_truth.csv')
...
output_ground_truth_file_path = os.path.join('../../data', dataset_path_name, 'output','cutoff_ground_truth.csv')
...
output_data_embed_file_path = os.path.join('../../data', dataset_path_name, 'output','data_embed.npy')
...
output_data_map_file_path = os.path.join('../../data', dataset_path_name, 'output','data_map.txt')
...
output_model_map_file_path = os.path.join('../../data', dataset_path_name, 'output','model_map.txt')
...
output_model_embed_file_path = os.path.join('../../data', dataset_path_name, 'output','model_embed.npy')
np.save(output_model_embed_file_path,model_embed)

#save the running time of threshold processing
'''
with open(os.path.join('../../data/kaggle/output', 'threshold_'+ str(threshold_score)+'_thresholdProcessing.txt'),'w')as f:
    f.write(str(threshold_time))
f.close()
'''

'''
with open(os.path.join('../../data/kaggle_partition/output', 'threshold_'+ str(threshold_score)+'_thresholdProcessing.txt'),'w')as f:
    f.write(str(threshold_time))
f.close()
'''
'''
with open(os.path.join('../../data/kaggle_ratio_0.2/output', 'threshold_'+ str(threshold_score)+'_thresholdProcessing.txt'),'w')as f:
    f.write(str(threshold_time))
f.close()
'''
with open(os.path.join('../../data', dataset_path_name, 'output', 'threshold_'+ str(threshold_score)+'_thresholdProcessing.txt'),'w')as f:
    f.write(str(threshold_time))
f.close()

#save the running time of probing processing
'''
with open(os.path.join('../../data/kaggle/output', 'probing_budget_'+ str(total_budget)+'.txt'),'w')as f:
    f.write(str(sum(knn_process_time)))
f.close()
'''
'''
with open(os.path.join('../../data/kaggle_partition/output', 'probing_budget_'+ str(total_budget)+'.txt'),'w')as f:
    f.write(str(sum(knn_process_time)))
f.close()
'''
'''
with open(os.path.join('../../data/kaggle_ratio_0.2/output', 'probing_budget_'+ str(total_budget)+'.txt'),'w')as f:
    f.write(str(sum(knn_process_time)))
f.close()
'''
with open(os.path.join('../../data', dataset_path_name,'output', 'probing_budget_'+ str(total_budget)+'.txt'),'w')as f:
    f.write(str(sum(knn_process_time)))
f.close()
