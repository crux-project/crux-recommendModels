...
#prediction_path = os.path.join('../../data/hugging_face/output', 'oracle_pred_hugging.csv')
prediction_path = os.path.join('../../data/hugging_face_ratio_0.8/output', 'oracle_pred_hugging.csv')
...
#second_level_data_node_map_path  = os.path.join('../../data/hugging_face/output', 'second_data_map.txt')
second_level_data_node_map_path  = os.path.join('../../data/hugging_face_ratio_0.8/output', 'second_data_map.txt')
#data_node_map_path = os.path.join('../../data/hugging_face/output', 'data_map.txt')
data_node_map_path = os.path.join('../../data/hugging_face_ratio_0.8/output', 'data_map.txt')
#model_node_map_path = os.path.join('../../data/hugging_face/output', 'model_map.txt')
model_node_map_path = os.path.join('../../data/hugging_face_ratio_0.8/output', 'model_map.txt')
...
df = pd.DataFrame(transformed_prediction, columns=['dataset', 'model','accuracy'])
print(df.dtypes)
df['dataset']=df['dataset'].astype('int')
df['model']=df['model'].astype('int')
#transformed_pred_path = os.path.join('../../data/hugging_face/output/final_result', 'oracle_hugging_face.csv')
transformed_pred_path = os.path.join('../../data/hugging_face_ratio_0.8/output/final_result', 'oracle_hugging_face_edge80.csv')
